          ...
          <div className="">
            <ul className="mb-8">
              <li class="inline-block mr-5 text-2xl text-secondary hover:text-secondary_hover hover:animate-bounce">
                <a href="https://github.com/mijankarim" target="_blank"><FaGithub /></a>
              </li>
              <li class="inline-block mr-5 text-2xl text-secondary hover:text-secondary_hover hover:animate-bounce">
              <a href="https://www.linkedin.com/in/mijankarim/" target="_blank"><FaLinkedin /></a>
              </li>
              <li class="inline-block mr-5 text-2xl text-secondary hover:text-secondary_hover hover:animate-bounce">
              <a href="https://twitter.com/mkatbd" target="_blank"><FaTwitterSquare /></a>
              </li>
            </ul>
          </div>
