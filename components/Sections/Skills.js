      ...
      <div className="container mx-auto px-4 sm:px-10">
        ...
        <div className="my-6 flex flex-wrap">
          {skillsData.map((skill) => (
            ...
            <div
              className="flex flex-col items-center  mr-3 sm:mr-8 mb-5 hover:animate-bounce transition duration-500"
              key={skill.id}
            >
              <span className="leading-custom text-xl sm:text-5xl text-secondary hover:text-secondary_hover">
                {skill.icon}
              </span>
